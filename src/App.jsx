...
const App = () => {
  ...
  const { contract: token } = useContract('0x772c569F9E3B43F768a69d2CaC6DaCAA3A5c7827', 'token');

  const { contract: vote } = useContract("0x0EcdA91793be037df0deA9A3Ef73b1dDE3FB3A8C", "vote");
